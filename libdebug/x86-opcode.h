...
int x86_opcode_is_call_relative (struct x86_opcode_parser *parser, int32_t *delta);
int x86_opcode_is_call_absolute_direct (struct x86_opcode_parser *parser, uint32_t *address);
int x86_opcode_is_call_absolute_indirect (struct x86_opcode_parser *parser);
int x86_opcode_is_jump (struct x86_opcode_parser *parser);
int x86_opcode_is_jump_relative (struct x86_opcode_parser *parser, int32_t *delta);
int x86_opcode_is_jump_absolute_direct (struct x86_opcode_parser *parser, uint32_t *address);
